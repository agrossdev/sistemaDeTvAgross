function imagemsorteio(numero1, numero2, numero3, numero4) {
    var numeros = [numero1.value, numero2.value, numero3.value, numero4.value]
    for (x = 0; x < 4; x++) {
        if (numeros[x] == '') {
            numeros[x] = '.';
        }
    ...
    for (y = 1; y < 5; y++) {
        if (y == 4) {
            numerofinal = numerofinal + sessionStorage.getItem('numero4');
        } else if (y == 1) {
